...
function register(mocha, expect) {
    ...
    function createRaster(url, shapeImageThreshold, shapeMargin, done) {
        ...
        return new Raster(url, shapeImageThreshold, shapeMargin, clipRect, done);
    }

    describe("Raster Basics", function(done) {
        var raster = createRaster("./resources/half-rectangle.png", 0, 0, done);
    ...
    describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px transparent)", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/half-rectangle.png", 0, 0, done);
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/half-rectangle.png", 0, 10, done);
    ...
    describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px 50% transparent)", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/half-rectangle-50.png", 0.5, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 50); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 50); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 50); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 50)} );
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/half-rectangle-50.png", 0.5, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 60); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 60); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 60)} );
            it("line overlaps image's bottom part", function() { checkExclusionEdges(image, 75, 100, -10, 60)} );
    ...
    describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px 70% opacity)", function() {
        describe("shape-margin=0; shape-image-threshold=0.7", function(done) {
            var image = createRaster("./resources/half-rectangle-70.png", 0.7, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 50); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 50); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 50); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 50)} );
        ...
        describe("shape-margin=10; shape-image-threshold=0.7", function(done) {
            var image = createRaster("./resources/half-rectangle-70.png", 0.7, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 60); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 60); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 60)} );
            it("line overlaps image's bottom part", function() { checkExclusionEdges(image, 75, 100, -10, 60)} );
    ...
    describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px 20% opacity)", function() {
        describe("shape-margin=0; shape-image-threshold=0.2", function(done) {
            var image = createRaster("./resources/half-rectangle-20.png", 0.2, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 50); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 50); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 50); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 50)} );
        ...
        describe("shape-margin=10; shape-image-threshold=0.2", function(done) {
            var image = createRaster("./resources/half-rectangle-20.png", 0.2, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 60); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 60); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 60)} );
            it("line overlaps image's bottom part", function() { checkExclusionEdges(image, 75, 100, -10, 60)} );
    ...
    describe("Image.left,rightExclusionEdge, (50x100px opaque, 50x100px 20% opacity)", function() {
        describe("shape-margin=0; shape-image-threshold=0.19 (no wrapping)", function(done) {
            var image = createRaster("./resources/half-rectangle-20.png", 0.19, 0, done);
        ...
        describe("shape-margin=10; shape-image-threshold=0.19 (no wrapping)", function(done) {
            var image = createRaster("./resources/half-rectangle-20.png", 0.19, 10, done);
    ...
    describe("Image.left,rightExclusionEdge, no outside transparency", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/no-outside-alpha.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 100); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 100)} );
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/no-outside-alpha.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 110)} );
            it("line overlaps image's bottom part", function() { checkExclusionEdges(image, 75, 100, -10, 110)} );
    ...
    describe("Image.left,rightExclusionEdge, left-base triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/left-based-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 100); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 100)} );
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/left-based-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, top-base triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/top-based-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/top-based-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 110)} );
    ...
    describe("Image.left,rightExclusionEdge, right-base triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/right-based-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 100); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 100)} );
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/right-based-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, bottom-base triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/bottom-based-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/bottom-based-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, top-left triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/top-left-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
            it("line overlaps image vertical extent, below", function() { checkExclusionEdges(image, 50, 150, 0, 50); });
            it("line contains image vertical extent", function() { checkExclusionEdges(image, -100, 200, 0, 100)} );
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/top-left-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, top-right triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/top-right-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/top-right-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
            it("line overlaps image's top part", function() { checkExclusionEdges(image, 0, 25, -10, 110)} );
    ...
    describe("Image.left,rightExclusionEdge, bottom-right triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/bottom-right-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/bottom-right-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, bottom-left triangle", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/bottom-left-triangle.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/bottom-left-triangle.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
    ...
    describe("Image.left,rightExclusionEdge, assimetric star", function() {
        describe("shape-margin=0", function(done) {
            var image = createRaster("./resources/assimetric-star.png", 0, 0, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, 0, 100); });
            it("line overlaps image vertical extent, above", function() { checkExclusionEdges(image, -100, 50, 0, 100); });
        ...
        describe("shape-margin=10", function(done) {
            var image = createRaster("./resources/assimetric-star.png", 0, 10, done);
            it("line equals image vertical extent", function() { checkExclusionEdges(image, 0, 100, -10, 110); });
            it("line equals image + shape-margin vertical extent", function() { checkExclusionEdges(image, -10, 110, -10, 110); });
